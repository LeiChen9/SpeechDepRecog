...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_list", type=str, default="./configs/train.txt", help="path to train list")
    parser.add_argument("--val_list", type=str, default="./configs/val.txt", help="path to val list")
