...
def process(item):
    # item is a tuple like (spk_dir, i, args))
    spkdir, wav_name, args = item
    # keep track of speaker id by file name
...
if __name__ == "__main__":
    ...
    parser.add_argument("--in_dir", type=str, default="/Users/lei/Documents/Projs/Yoda/Data/EATD-Corpus/", help="path to source dir")
    parser.add_argument("--out_dir2", type=str, default="/Users/lei/Documents/Projs/Yoda/Data/EATD-Corpus-pcd/", help="path to target dir")
